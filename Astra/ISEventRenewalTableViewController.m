...
@interface ISEventRenewalTableViewController () {
	UIPopoverController *monthPickerPopover;
}

@end

@implementation ISEventRenewalTableViewController
...
- (void)viewDidLoad
{
	...
	self.title = NSLocalizedStringWithDefaultValue(@"renewal reminder", nil, currentLanguageBundle, @"renewal reminder", nil);
	...
	_items = @[
			   @[@"2 Oct 2014",@"1000035720",@"HEQU",@"2 Nov 2014",@"8 Nov 2013\n8 Nov 2014",@"col6"],
			   @[@"8 Oct 2014",@"1000035734",@"HEQU",@"8 Nov 2014",@"22 Nov 2013\n22 Nov 2014",@"col6"]
			   ];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
	...
	_label5.text = NSLocalizedStringWithDefaultValue(@"Policy period", nil, currentLanguageBundle, @"Policy period", nil);
	_label6.text = NSLocalizedStringWithDefaultValue(@"Insurer", nil, currentLanguageBundle, @"Insurer", nil);
