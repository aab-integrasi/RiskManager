...
@interface ISManagePolicyTableViewController ()

@end

@implementation ISManagePolicyTableViewController
...
- (void)viewDidLoad
{
	...
	_items = @[@"10000326721 - PT Asuransi Astra\nHeavy Equipment\n21 Dec 2014 - 21 Dec 2015",
			   @"10000326721 - PT Asuransi Astra\nHeavy Equipment\n21 Jan 2014 - 21 Jan 2015",
			   @"10000326721 - PT Tokyo Marine\nMarine Cargo\n21 Dec 2014 - 21 Mar 2015",
			   @"10000326721 - PT Sinarmas\nHeavy Equipment\n2 Dec 2014 - 2 Dec 2015"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	ISManagePolicyDetailTableViewController *detailView = [[ISManagePolicyDetailTableViewController alloc] init];
	detailView.policyID = [NSString stringWithFormat:@"(row: %ld)", (long)indexPath.row+1];
