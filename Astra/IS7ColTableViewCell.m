...
@implementation IS7ColTableViewCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
		...
		_label5.font = [UIFont preferredFontForTextStyle:UIFontTextStyleSubheadline];
		_label6.font = [UIFont preferredFontForTextStyle:UIFontTextStyleSubheadline];
		_label7.font = [UIFont preferredFontForTextStyle:UIFontTextStyleSubheadline];
